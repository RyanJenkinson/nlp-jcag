...
def clean_dataframe(df,max_wordcount_punchline,max_wordcount_setup):
...
if __name__ == '__main__':
    ...
    infilename = join(current_dir,"../data/processed_data/jokes_dataset.csv")

    df = pd.read_csv(infilename)

    cleaned_df = clean_dataframe(df,50,20)

    outfilename = join(current_dir,"../data/processed_data/jokes_dataset_CLEAN.csv")
